...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <article className="group rounded-[1.75rem] border border-stone-200 bg-white p-6 shadow-[0_20px_50px_rgba(53,42,31,0.07)] transition hover:-translate-y-0.5 hover:shadow-[0_28px_70px_rgba(53,42,31,0.12)]">
      ...
      <div className="mt-5 flex flex-col gap-4">
        ...
        <dl className="grid gap-4 text-sm text-stone-700 md:grid-cols-4">
          <div>
