  ...
  return (
    <header className="sticky top-0 z-50 bg-white/96 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-7xl items-start justify-between gap-8 px-5 py-5 lg:px-8">
        <Link
          href="/"
          aria-label="jonathan brent"
          className="text-[2.1rem] leading-none font-semibold tracking-[-0.04em] text-black sm:text-[3.1rem]"
        >
          <span className="italic">j</span>onathan{" "}
          <span className="italic">b</span>rent
        </Link>
